...
namespace NanoORM
{
    ...
    public sealed class DBHelper : NanoOrm
    {
        ...
        /// </summary>
        public const string CONNECTION_STRING = "Database=testorm;DataSource=10.110.50.113;Uid=root;Password=*****;CharSet=utf8;DefaultCommandTimeout=300;ConnectionTimeout=300;";
